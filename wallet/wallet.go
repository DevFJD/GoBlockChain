...
func NewWallet() *Wallet {
	...
	// Perform RIPEMD-160 hashing on the result of SHA-256 (20 byte)
	h3 := ripemd160.New()
	h3.Write(digest2)
	digest3 := h3.Sum(nil)
	...
	// Take the first 4 bytes of the second SHA-256 for checksum
	chsum := digest6[:4]
	...
	// Convert the result from byte string into base58
